...
description: "Configure when ralph stops: completion markers, max iterations, error thresholds, and custom exit conditions."
---
...
```d2 theme=301
ai_exit: AI exits iteration
check: Check exit conditions
done: Done?
complete: Complete marker → Exit
no: No → Loop again
max: Max reached → Exit
