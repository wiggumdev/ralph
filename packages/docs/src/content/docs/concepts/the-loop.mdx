...
│                  └──────────┘    └───────────┘            │
│                                                             │
│   State persists via: git commits, files, test results     │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
4. **Save State** — Commits changes, updates progress markers
...
```
Iteration 1: Fresh model → reads files → does work → exits
Iteration 2: Fresh model → reads updated files → does more work → exits
Iteration 3: Fresh model → reads further updates → finishes → exits
```
