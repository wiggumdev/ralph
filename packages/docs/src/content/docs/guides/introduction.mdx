---
title: Introduction
description: What is ralph and why does it exist?
---
...
Unlike tool-specific solutions, ralph works with any CLI-based AI coding tool:

- **Claude Code** — Anthropic's official CLI
- **OpenCode** — Open-source alternative
- **Aider** — Git-integrated coding assistant
- **Any CLI tool** — If it takes a prompt and writes code, ralph can loop it
