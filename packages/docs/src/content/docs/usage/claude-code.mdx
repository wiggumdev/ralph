...
2. **Install the plugin**
   ```
   /plugin install ralph@wiggumdev/ralph
   ```
...
<CardGrid>
  <Card title="ralph-prd" icon="rocket">
    Generate a new PRD from scratch with guided clarifying questions.
  </Card>
  <Card title="ralph-tasks" icon="document">
    Convert existing PRD documents to Ralph's prd.json format.
  </Card>
</CardGrid>
