...
export default defineConfig({
  ...
  integrations: [starlight({
    ...
    head: [
      {
        tag: "meta",
        attrs: { property: "og:image", content: `${config.url}/og.png` },
      },
      {
        tag: "meta",
      ...
      {
        tag: "meta",
        attrs: { property: "og:site_name", content: "ralph" },
      },
      {
        tag: "meta",
      ...
      {
        tag: "meta",
        attrs: { name: "twitter:image", content: `${config.url}/og.png` },
      },
      {
        tag: "meta",
        attrs: { name: "theme-color", content: "#FFD93D" },
      },
      {
        tag: "link",
        attrs: {
